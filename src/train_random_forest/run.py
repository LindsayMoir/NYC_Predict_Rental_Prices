...
def go(args):
    ...
    logger.info(f"Reading data from {trainval_local_path}")

    # Load the data
    X = pd.read_csv(trainval_local_path)

    # this removes the column "price" from X and puts it into y. Very slick!
    y = X.pop("price") 
    ...
    model_artifact = wandb.Artifact(
        ...
        metadata={"rf_config": rf_config}  # Adding metadata here
    )
